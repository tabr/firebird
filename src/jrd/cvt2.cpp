...
const BYTE CVT2_compare_priority[] =
{
	...
	11,	// dtype_quad
	// Also leave space for dec64 and dec 128.
	14,	// dtype_real
	15,	// dtype_double
	16,	// dtype_d_float
	17,	// dtype_sql_date
	...
	24,	// dtype_dbkey - compares with nothing except itself
	25,	// dtype_boolean - compares with nothing except itself
	12,	// dec64 - go after quad
	13,	// dec128 - go after dec64 and before real
	13,	//// FIXME: master - dtype_dec_fixed
	19,	// dtype_sql_time_tz - go after dtype_sql_time
	21	// dtype_timestamp_tz - go after dtype_timestamp
};
